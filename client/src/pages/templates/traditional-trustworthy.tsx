...
export default function TraditionalTrustworthyTemplate() {
  return (
    <div className="min-h-screen bg-[#f7f5f0] text-[#1f2733]">
      ...
      <header className="border-b border-[#d8d2c2] bg-white">
        <div className="container mx-auto flex items-center justify-between px-6 py-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-display text-2xl text-[#13233f]">Heritage Manor</h1>
              <p className="text-xs uppercase tracking-[0.15em] text-[#8a8367]">Adult Family Home</p>
            </div>
          </div>
      ...
      <section className="container mx-auto grid items-center gap-12 px-6 py-20 md:grid-cols-2">
        <div>
          <h2 className="font-display mb-6 text-4xl leading-tight text-[#13233f] md:text-5xl">
            Trusted, dignified care for over 25 years.
          </h2>
          <p className="mb-8 text-lg text-[#48505c]">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button size="lg" variant="outline" className="border-2 border-[#13233f] text-[#13233f]">Our Credentials</Button>
          </div>
        </div>
        <img src={afh3Image} alt="Attentive personal care at Heritage Manor" className="h-96 w-full rounded-md object-cover shadow-xl" />
      </section>

      <section className="border-y border-[#d8d2c2] bg-white py-10">
        <div className="container mx-auto grid grid-cols-2 gap-6 px-6 text-center md:grid-cols-4">
          {[
            ...
            <div key={item.label} className="flex flex-col items-center gap-2">
              ...
              <p className="text-sm font-medium text-[#48505c]">{item.label}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 py-20">
        <h3 className="font-display mb-10 text-center text-3xl text-[#13233f]">Our Commitment to Families</h3>
        <div className="grid gap-8 md:grid-cols-3">
          {[
            ...
            <Card key={item.title} className="border border-[#d8d2c2] bg-white shadow-none">
              <CardContent className="p-8">
                <h4 className="font-display mb-3 text-xl text-[#13233f]">{item.title}</h4>
                <p className="text-[#48505c]">{item.body}</p>
              </CardContent>
            </Card>
          ))}
        </div>
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto grid items-center gap-12 px-6 md:grid-cols-2">
          ...
          <blockquote className="border-l-4 border-[#d4af6a] pl-6 text-xl italic text-[#1f2733]">
            ...
            <footer className="mt-4 text-sm font-medium text-[#8a8367]">— The Coleman Family</footer>
          </blockquote>
        </div>
      </section>
