...
export default function MinimalistAiryTemplate() {
  return (
    <div className="min-h-screen bg-[#fbfaf8] text-[#2a2a28] dark:bg-stone-950 dark:text-stone-100">
      <header className="border-b border-[#e7e3dc] dark:border-stone-800">
        <div className="container mx-auto flex items-center justify-between px-6 py-6">
          <span className="text-lg font-light tracking-[0.2em]">WILLOW COURT</span>
          <a href="#" className="flex items-center gap-2 text-sm text-[#6b6a64] hover:text-[#2a2a28] dark:text-stone-300 dark:hover:text-white">
      ...
      <section className="container mx-auto px-6 py-28 text-center">
        <p className="mb-6 text-xs uppercase tracking-[0.3em] text-[#9b9890] dark:text-stone-400">Adult Family Home</p>
        ...
        <p className="mx-auto mt-8 max-w-xl text-lg text-[#6b6a64] dark:text-stone-300">
          Willow Court offers calm, uncluttered living for a small number of residents — space to breathe, and people who notice.
        </p>
        <a href="#tour" className="mt-10 inline-flex items-center gap-2 border-b border-[#2a2a28] pb-1 text-sm tracking-wide dark:border-stone-100">
      ...
      <section className="border-t border-[#e7e3dc] dark:border-stone-800">
        <div className="container mx-auto grid gap-16 px-6 py-24 md:grid-cols-3">
          {[
            ...
            <div key={item.title} className="text-center md:text-left">
              <h3 className="mb-3 text-sm uppercase tracking-[0.25em] text-[#9b9890] dark:text-stone-400">{item.title}</h3>
              <p className="text-lg leading-relaxed text-[#3f3e3a] dark:text-stone-200">{item.body}</p>
            </div>
          ))}
        </div>
      </section>

      <section className="border-t border-[#e7e3dc] bg-white dark:border-stone-800 dark:bg-stone-900">
        <div className="container mx-auto grid items-center gap-12 px-6 py-24 md:grid-cols-2">
          ...
          <blockquote className="text-2xl font-light leading-relaxed text-[#2a2a28] dark:text-stone-100">
            “It doesn't feel like a facility. It feels like somewhere my mother actually lives.”
            <footer className="mt-4 text-sm text-[#9b9890] dark:text-stone-400">— A Willow Court family member</footer>
          </blockquote>
        </div>
      </section>
      ...
      <section id="tour" className="container mx-auto px-6 py-24 text-center">
        ...
        <p className="mx-auto mb-8 max-w-md text-[#6b6a64] dark:text-stone-300">Tours are unhurried, by appointment, with no obligation.</p>
        <div className="flex flex-col items-center justify-center gap-2 text-sm text-[#6b6a64] dark:text-stone-300">
      ...
      <footer className="border-t border-[#e7e3dc] py-10 text-center text-xs uppercase tracking-[0.25em] text-[#9b9890] dark:border-stone-800 dark:text-stone-400">
