...
import { Phone, MapPin, Crown, Diamond, Sparkles, Wine, Utensils, Car, Shield, Star } from "lucide-react";
...
export default function BluebirdHavenTemplate() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-blue-950 dark:to-indigo-950">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4 elegant-slide-in">
              ...
              <div>
                <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-800 via-indigo-700 to-blue-900 bg-clip-text text-transparent">Bluebird Haven</h1>
                <p className="text-sm text-blue-600 dark:text-blue-400 font-medium tracking-wide">LUXURY ADULT FAMILY HOME</p>
              </div>
            </div>

            <nav className="hidden lg:flex space-x-8">
              {["Home", "Luxury Care", "Amenities", "Concierge", "Contact"].map((item) => (
                <a key={item} href={`#${item.toLowerCase().replace(" ", "-")}`} className="text-slate-700 dark:text-slate-300 hover:text-blue-700 dark:hover:text-blue-400 font-medium transition-all duration-300 hover:scale-105 relative group">
                  {item}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="luxury-fade-in">
              ...
              <h2 className="text-6xl md:text-7xl font-bold text-slate-800 dark:text-slate-100 mb-8 leading-tight">
                Experience
                <span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-800 bg-clip-text text-transparent block luxury-shimmer">Unparalleled</span>
                <span className="text-slate-600 dark:text-slate-400 text-5xl md:text-6xl">Elegance</span>
              </h2>
              <p className="text-xl text-slate-600 dark:text-slate-300 mb-10 leading-relaxed">
                At Bluebird Haven, we redefine luxury senior living. Our boutique adult family home offers an exclusive, sophisticated
                environment where discerning residents enjoy five-star amenities, personalized care, and uncompromising attention to
                detail.
              </p>
            ...
            <div className="relative luxury-slide-in">
              ...
              <div className="relative">
                <img src={afh2Image} alt="Elegant personalized care at Bluebird Haven" className="rounded-3xl shadow-2xl w-full transform hover:scale-105 transition-transform duration-700" />
      ...
      <section id="luxury-care" className="py-24 bg-white/70 dark:bg-slate-800/30 backdrop-blur-sm">
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            <h3 className="text-5xl font-bold text-slate-800 dark:text-slate-100 mb-6">Luxury Care Services</h3>
            <p className="text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto">Every detail crafted for comfort, dignity, and sophistication</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Card
                key={index}
                className="luxury-service-card hover:shadow-2xl transition-all duration-700 hover:-translate-y-4 bg-white/90 dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 backdrop-blur-sm"
              ...
              >
                <CardContent className="p-8">
                  ...
                  <h4 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-4 text-center">{service.title}</h4>
                  <p className="text-slate-600 dark:text-slate-400 mb-6 text-center leading-relaxed">{service.description}</p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="luxury-content-slide">
              <h3 className="text-5xl font-bold text-slate-800 dark:text-slate-100 mb-8">Exclusive Amenities</h3>
              <p className="text-xl text-slate-600 dark:text-slate-300 mb-10 leading-relaxed">
                Every space designed with luxury and comfort in mind, featuring the finest materials and attention to detail that
            ...
            <div className="luxury-image-grid">
              <div className="grid grid-cols-2 gap-6">
                <img src={afh6Image} alt="Comfortable luxury social spaces" className="rounded-2xl shadow-xl hover:scale-105 transition-transform duration-700 col-span-2" />
                <img src={afh3Image} alt="Personalized dining experience" className="rounded-xl shadow-lg hover:scale-105 transition-transform duration-700" />
                <img src="https://images.unsplash.com/photo-1600566753051-f43c1ec87da8?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300" alt="Luxury bedroom" className="rounded-xl shadow-lg hover:scale-105 transition-transform duration-700" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="concierge" className="py-24 bg-gradient-to-br from-slate-800 via-blue-900 to-indigo-900 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h3 className="text-5xl font-bold mb-6">Begin Your Luxury Experience</h3>
              <p className="text-xl opacity-90 max-w-2xl mx-auto">
                Discover the ultimate in sophisticated senior living. Schedule a private tour and experience the Bluebird Haven
                difference.
              </p>
            </div>

            <div className="grid lg:grid-cols-2 gap-16 items-center" id="contact">
              <div className="space-y-10">
                ...
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-8 rounded-2xl">
                  ...
                  <p className="text-blue-100 leading-relaxed">
                    Bluebird Haven maintains an exclusive waiting list. Contact our concierge team for availability and to arrange a
                    private consultation with our director.
                  </p>
                </div>
              </div>
              ...
              <Card className="bg-white/10 backdrop-blur-md border border-white/20">
                <CardContent className="p-10">
                  <h4 className="text-3xl font-bold text-white mb-8 text-center">Request Private Tour</h4>
                  <form className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-4">
                      <input type="text" placeholder="First Name" className="w-full p-4 rounded-xl bg-white/10 border border-white/30 text-white placeholder-blue-200 backdrop-blur-sm" />
                      <input type="text" placeholder="Last Name" className="w-full p-4 rounded-xl bg-white/10 border border-white/30 text-white placeholder-blue-200 backdrop-blur-sm" />
                    </div>
                    <input type="tel" placeholder="Phone Number" className="w-full p-4 rounded-xl bg-white/10 border border-white/30 text-white placeholder-blue-200 backdrop-blur-sm" />
                    <input type="email" placeholder="Email Address" className="w-full p-4 rounded-xl bg-white/10 border border-white/30 text-white placeholder-blue-200 backdrop-blur-sm" />
                    ...
                    <textarea placeholder="Tell us about your specific needs and preferences..." rows={4} className="w-full p-4 rounded-xl bg-white/10 border border-white/30 text-white placeholder-blue-200 backdrop-blur-sm resize-none"></textarea>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-4 mb-8">
              ...
              <div>
                <h4 className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Bluebird Haven</h4>
                <p className="text-blue-400 font-medium">Luxury Adult Family Home</p>
              </div>
            </div>
            <p className="text-slate-400 mb-6 max-w-2xl mx-auto">
              Where sophisticated living meets compassionate care. An exclusive community designed for discerning individuals who
              value luxury, privacy, and exceptional service.
            </p>
            <div className="space-y-2">
              <p className="text-slate-500 text-sm">© 2024 Bluebird Haven Luxury Adult Family Home. All rights reserved.</p>
              <p className="text-blue-400 text-sm">Licensed Luxury AFH #987654 | Member of Exclusive Care Communities</p>
              <p className="text-slate-600 text-xs">💎 Exceptional care for exceptional lives • (555) 888-9999</p>
            </div>
          </div>
        </div>
      </footer>
      ...
      <style>{`
        ...
        .elegant-slide-in { animation: elegantSlideIn 1s ease-out; }
        .luxury-fade-in { animation: luxuryFadeIn 1s ease-out; }
        .luxury-slide-in { animation: luxurySlideIn 1s ease-out 0.3s both; }
        .luxury-float { animation: luxuryFloat 4s ease-in-out infinite; }
        .luxury-float-delayed { animation: luxuryFloat 4s ease-in-out infinite 2s; }
        .luxury-service-card { animation: luxuryServiceCard 0.8s ease-out both; }
        .luxury-icon-float { animation: luxuryIconFloat 3s ease-in-out infinite; }
        .luxury-shimmer {
          background: linear-gradient(90deg, transparent, rgba(59, 130, 246, 0.1), transparent);
          background-size: 200% 100%;
          animation: luxuryShimmer 3s ease-in-out infinite;
        }
        .sparkle-animation { animation: sparkleAnimation 2s ease-in-out infinite; }
        .luxury-content-slide { animation: luxuryContentSlide 1s ease-out; }
        .luxury-image-grid { animation: luxuryImageGrid 1s ease-out 0.2s both; }
        .luxury-amenity-item { animation: luxuryAmenityItem 0.6s ease-out both; }
