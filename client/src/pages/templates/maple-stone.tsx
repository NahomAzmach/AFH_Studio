        ...
        <div className="container mx-auto px-4 py-6">
          <div className="text-center border-b-2 border-amber-600 pb-4 mb-4">
            <div className="flex items-center justify-center space-x-4 mb-2">
              ...
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-stone-800 dark:text-stone-100 tracking-wide">THE MAPLE & STONE</h1>
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 text-sm font-semibold">
            ...
            <Button className="bg-amber-600 hover:bg-amber-700 text-white font-bold">SCHEDULE VISIT TODAY</Button>
          </div>
        </div>
      </header>
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          <div className="lg:col-span-3">
            <article className="bg-white dark:bg-stone-800 border border-stone-200 dark:border-stone-700 rounded-lg overflow-hidden shadow-lg mb-8">
              ...
              <img src={afh2Image} alt="Professional care and personal attention at Maple & Stone" className="w-full h-64 object-cover" />
              <div className="p-8">
                ...
                <p className="text-amber-600 font-semibold mb-4 text-lg">By Sarah Johnson, Health Reporter | March 15, 2024</p>
                <div className="text-lg text-stone-700 dark:text-stone-300 leading-relaxed space-y-4">
                  <p>
                    <strong>HERITAGE HEIGHTS, WA</strong> — In 1995, when the Johnson family first opened the doors of Maple & Stone Adult
                    Family Home, they had a simple mission: provide the kind of care they would want for their own family members.
                  </p>
                  <p>
                    Nearly three decades later, that philosophy has made Maple & Stone one of the most trusted names in adult family
                    care, serving over 500 families and maintaining an unprecedented 98% satisfaction rating.
                  </p>
                  <p>
                    "We're not just a business," says Margaret Johnson, third-generation owner and administrator. "We're a family
                    caring for families. Every resident becomes part of our extended family tree."
                  </p>
                </div>
              </div>
            </article>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <Card className="bg-white dark:bg-stone-800 border border-stone-200 dark:border-stone-700">
                ...
                <img src={afh4Image} alt="Residents enjoying community activities" className="w-full h-40 object-cover" />
            ...
            <Card className="bg-gradient-to-b from-amber-100 to-amber-50 dark:from-amber-900 dark:to-amber-950 border-2 border-amber-400">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-amber-700 dark:text-amber-300 mb-3">
                  "Best Adult Family Home 2023"
                  <br />— Regional Health Guide
                </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-stone-700 dark:text-stone-300 mb-4">
                For immediate placement in Heritage Heights' most trusted adult family home. Must value quality care, family
                atmosphere, and 28-year legacy of excellence.
              </p>
            ...
            <Card className="bg-white dark:bg-stone-700 border-2 border-amber-600">
              ...
              <CardContent className="p-6">
                <form className="space-y-4">
                  <input type="text" placeholder="Your Name" className="w-full p-3 border border-stone-300 dark:border-stone-600 rounded bg-white dark:bg-stone-800" />
                  <input type="tel" placeholder="Phone Number" className="w-full p-3 border border-stone-300 dark:border-stone-600 rounded bg-white dark:bg-stone-800" />
                  <textarea placeholder="Tell us about your needs..." rows={3} className="w-full p-3 border border-stone-300 dark:border-stone-600 rounded bg-white dark:bg-stone-800 resize-none"></textarea>
                  <Button className="w-full bg-amber-600 hover:bg-amber-700 text-white font-bold py-3">SUBMIT INQUIRY</Button>
                </form>
              </CardContent>
            </Card>
          </div>
      ...
      <footer className="bg-stone-800 dark:bg-stone-950 text-stone-300 py-8 border-t-4 border-amber-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="border-t border-stone-600 pt-4">
            <p className="text-stone-400 text-sm">© 2024 Maple & Stone Adult Family Home • Licensed AFH #654321 • All Rights Reserved</p>
            <p className="text-amber-500 text-xs mt-1">"Where Family Values Meet Professional Care" • (555) 789-0123</p>
          </div>
        </div>
      </footer>
