      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground mb-6">
            I understand Adult Family Homes because they're part of my family's story. My relatives own and
            operate AFHs, so I've seen firsthand the challenges of finding the right families, building
            trust, and managing all the moving parts of running a care home.
          </p>
          <p className="text-lg text-muted-foreground mb-6">
            As a recent Computer Science graduate from Western Washington University (with minors in
            Biology and Chemistry), I'm heading to the University of Washington for my Master's degree in
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <div className="space-y-6">
              {[
                { step: "1", title: "Pick Your Template", description: "Choose from our AFH-specific designs or let us recommend the best fit." },
                { step: "2", title: "Customize Everything", description: "We tailor colors, photos, and copy to match your home's personality and services." },
                { step: "3", title: "QA & Launch", description: "Thorough testing across devices before going live with your approval." },
                { step: "4", title: "Ongoing Care", description: "Regular updates, monitoring, and support to keep your site running smoothly." },
              ].map((item, index) => (
          ...
          <div>
            <img src={processImage} alt="Nahom - Web development expert and AFH website specialist" className="rounded-2xl shadow-xl w-full" />
          </div>
        </div>
        ...
        <Card className="p-8">
          ...
          <div className="grid md:grid-cols-4 gap-6 text-center">
            {[
              { icon: Eye, title: "Clarity", description: "Every element serves a purpose", color: "primary" },
              { icon: Heart, title: "Empathy", description: "Understanding family concerns", color: "secondary" },
              { icon: Zap, title: "Speed", description: "Fast launch and quick updates", color: "accent" },
              { icon: Shield, title: "Reliability", description: "Always there when you need us", color: "primary" },
            ].map((value, index) => (
              <div key={index}>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Growing up around my family's AFH operations, I've witnessed the daily challenges: managing
                  state regulations, building trust with worried families, and communicating the warmth and
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  My Computer Science background, combined with studies in Biology and Chemistry, gives me a
                  unique perspective on healthcare technology and the importance of clear, trustworthy
                  communication.
                </p>
                <ul className="space-y-2 text-sm">
        ...
        <div className="mt-16 bg-muted rounded-2xl p-8 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Having seen the impact of quality AFH care on families through my own relatives' work, I want to
            help more families discover and connect with the right care homes. A professional website
            shouldn't be a barrier—it should be a bridge that helps families find the compassionate care
