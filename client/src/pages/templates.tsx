            ...
            <Card key={template.id} className="overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  {template.featured && (
                    <span className="bg-primary/10 text-primary px-2 py-1 rounded text-xs font-medium">Live Demo</span>
                  )}
                </div>
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <Link href={`/contact?template=${template.id}`}>
                    <Button variant="outline" className="w-full" data-testid={`template-select-${template.id}`}>
                      Use This Template
                    </Button>
                  </Link>
                </div>
